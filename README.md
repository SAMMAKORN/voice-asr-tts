...
| แถบล่าง | สถานะไมค์ (ฟัง / คิด / พูด) ปุ่มหยุด ปิดเสียง โหมดหูฟัง ตัวเลือกเสียงพูด ล้างประวัติ และช่องพิมพ์ข้อความ |
...
หรือเปลี่ยนไปใช้แบ็กเอนด์ Microsoft Edge ตามหัวข้อถัดไป
